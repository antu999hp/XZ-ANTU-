...
module.exports = {
  ...
  onChat: async function ({ api, event }) {
    const randomReplies = ["𝐁𝐨𝐥𝐨 𝐣𝐚𝐧 𝐤𝐢 𝐤𝐨𝐫𝐭𝐞 𝐩𝐚𝐫𝐢 𝐭𝐦𝐫 𝐣𝐨𝐧𝐧𝐨🥹", "𝐆𝐚𝐣𝐚 𝐤𝐡𝐚 𝐦𝐚𝐧𝐮𝐬𝐡 𝐡𝐨 🍁🤡", "আম গাছে আম নাই ঢিল কেন মারো, তোমার সাথে প্রেম নাই বেবি কেন ডাকো 😒🐸", "দূরে যা, তোর কোনো কাজ নাই, শুধু 𝗯𝗯𝘆 𝗯𝗯𝘆 করিস 🐸", "𝐀𝐦𝐚𝐤𝐞 𝐞𝐭𝐨 𝐧𝐚 𝐝𝐞𝐤𝐞 𝐚𝐦𝐫 𝐛𝐨𝐬s antu 𝐤𝐞 𝐞𝐤𝐭𝐚 go𝐟 𝐝𝐞 😾", "𝐄𝐭𝐨 𝐛𝐚𝐛𝐲 𝐛𝐚𝐛𝐲 𝐤𝐨𝐫𝐨𝐬𝐡 𝐤𝐢𝐥𝐥𝐚𝐢 😒", "𝗔𝗺𝗿 𝗯𝗼𝘀𝘀 𝗷𝗲 𝘀𝗶𝗻𝗴𝗹𝗲 𝗰𝗵𝗼𝗸𝗲 𝗽𝗼𝗿𝗲 𝗻𝗮 𝘁𝗼𝗿 😒", "𝕂𝕚 𝕜𝕠𝕓𝕚 𝕜𝕠 𝕥𝕠𝕣 𝕛𝕠𝕟𝕟𝕠𝕚 𝕓𝕠𝕤𝕖 𝕒𝕔𝕙𝕚 😒", "𝐇𝐚𝐫𝐚𝐦𝐣𝐚𝐝𝐢 𝐛𝐨𝐥 𝐤𝐢 𝐛𝐨𝐥𝐛𝐢 🙈", "বার বার ডাকলে মাথা গরম হয় কিন্তু 😒", "𝐁𝐨𝐥𝐨 𝐛𝐞𝐟𝐲 𝐤𝐢 𝐛𝐨𝐥𝐛𝐚 😭", "𝙑𝙝𝙪𝙡𝙚 𝙟𝙖𝙬 𝙖𝙢𝙖𝙠𝙚 😞", "𝗔𝗺𝗿 𝗯𝗼𝘀𝘀 antu 𝗲𝗿 𝗺𝗼𝗻 𝗸𝗵𝗮𝗿𝗮𝗽 𝗯𝗼𝘀𝘀 𝗲𝗿 go𝗳 𝗻𝗮𝗶 😿"," তুই কালকে দেখা করিস তো একটু 😈", "𝗮𝘀𝘀𝗮𝗹𝗮𝗺𝘂𝗹𝗮𝗶𝗸𝘂𝗺🥳🥳","ইস যদি কোনো মেয়ে আমাকে একা পেয়ে খেয়ে দিতো..!🥺🙂","Antu 𝗿𝗲 𝗱𝗮𝗸🙈𝐨𝐫 𝐬𝐚𝐭𝐞 𝐩𝐫𝐞𝐦 𝐤𝐨𝐫𝐢","𝐊𝐢 𝐡𝐨𝐢𝐬𝐞 𝐣𝐚𝐧𝐮𝐮😘"];
